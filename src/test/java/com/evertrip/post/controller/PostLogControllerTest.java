...
class PostLogControllerTest extends RestDocsTestSupport {
    ...
    public void getvisitorshistory_200() throws Exception {
        ...
        mockMvc.perform(get("/api/post-logs/{post-id}/visitors/history",post.getId())
                ...
                .andExpect(jsonPath("$.content[0].nickName").value("김강욱"))
                .andExpect(jsonPath("$.content[0].profileImage").value("https://evertrip-bucket.s3.ap-northeast-2.amazonaws.com/stock-696x365.jpg_10300645-24df-490e-b8ed-579709b278f0"))
                .andExpect(jsonPath("$.content[0].eventCreatedAt").value("2024/06/09 13:13:00"))
                .andExpect(jsonPath("$.content[17].memberId").value(1L))
                .andExpect(jsonPath("$.content[17].nickName").value("김강욱"))
                .andExpect(jsonPath("$.content[17].profileImage").value("https://evertrip-bucket.s3.ap-northeast-2.amazonaws.com/stock-696x365.jpg_10300645-24df-490e-b8ed-579709b278f0"))
    ...
    public void gethistory_200() throws Exception {
        ...
        mockMvc.perform(get("/api/post-logs/{post-id}/history",post.getId())
                ...
                .andExpect(jsonPath("$.success").value(true))
                .andExpect(jsonPath("$.errorResponse").value(nullValue()))
                .andExpect(jsonPath("$.content[0].memberId").value(3L))
                ...
                .andExpect(jsonPath("$.content[5].memberId").value(1L))
                .andExpect(jsonPath("$.content[5].nickName").value("김강욱"))
                .andExpect(jsonPath("$.content[5].profileImage").value("https://evertrip-bucket.s3.ap-northeast-2.amazonaws.com/stock-696x365.jpg_10300645-24df-490e-b8ed-579709b278f0"))
